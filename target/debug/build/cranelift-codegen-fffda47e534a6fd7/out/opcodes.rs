...
const OPCODE_CONSTRAINTS: [OpcodeConstraints; 185] = [
    ...
    // Polymorphic over TypeSet(lanes={1, 2, 4, 8, 16, 32, 64, 128, 256}, ints={8, 16, 32, 64, 128}, floats={16, 32, 64, 128}, refs={32, 64})
    OpcodeConstraints {
        flags: 0x21,
        typeset_offset: 5,
...
const TYPE_SETS: [ir::instructions::ValueTypeSet; 23] = [
    ...
    ir::instructions::ValueTypeSet {
        // TypeSet(lanes={1, 2, 4, 8, 16, 32, 64, 128, 256}, ints={8, 16, 32, 64, 128}, floats={16, 32, 64, 128}, refs={32, 64})
        lanes: ScalarBitSet::<u16>(511),
        dynamic_lanes: ScalarBitSet::<u16>(510),
        ints: ScalarBitSet::<u8>(248),
        floats: ScalarBitSet::<u8>(240),
...
const OPERAND_CONSTRAINTS: [OperandConstraint; 81] = [
